...
def game_tutorial(player):
    ...
    PrintColors.print_subheader3_text("Welcome to the move tutor!")
    PrintColors.print_subheader3_row()
    with open("shell/spells.txt", "rb") as f:
        for line in f:
